...
<form id="formContact" name="formulaire_envoi_message" method="POST" action="../Php/index.php?EX=sendMail">
    ...
    <div class="contactChamp">
        <input type="email" id="mail" name="mail" placeholder="Quelle est votre adresse Mail ?" required="required" value="" class="erreurLab">
    ...
    <div class="contactChamp">
        <textarea id="msg" name="msg" placeholder="Tapez ici votre message..." required="required" class="erreurLab"></textarea>
        <label for="msg" style="width: 20%;" class="erreurLab">Messages *</label>
    </div>
